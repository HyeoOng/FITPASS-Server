...
public class UserServiceImpl implements UserService {
    ...
    public boolean signup(SignupUserDto signupUserDto) {
        ...
        try {
            ...
            if (result != 1) {
                throw new RegDBException("회원 가입 중 오류가 발생했습니다."); // RegDBException - DB PK 오류
            }
            ...
            try{
                ...
                throw new RegDBException("salt 삽입 중 DB 오류 발생"); // RegDBException
            }

            return true;
        } catch (DataAccessException e) {
            throw new RegDBException("회원 가입 중 데이터베이스 오류가 발생했습니다."); // RegDBException - DB 에러
        }
    }
    ...
    public RetUser handleLogin(LoginUserDto loginUserDto) {
        ...
        if (!isUserExist(email)) {
            throw new UserException("존재하지 않는 이메일입니다.", "NF"); // UserException - NF
        }

        // 2. 로그인 시도 횟수 초과로 차단된 사용자 확인
        if (loginAttemptService.isBlocked(email)) {
            throw new UserException("로그인 시도 횟수 초과로 인해 차단되었습니다.", "TC"); // UserException - TC
        }

        // 3. 비밀번호 체크
        String salt = userSecuDao.selectSalt(loginUserDto.getEmail());
        if (salt == null) {
            throw new UserException("이메일이 존재하지 않습니다.", "NF"); // UserException - NF
        }
        ...
        if (user == null) {
            ...
            throw new UserException("잘못된 이메일 또는 비밀번호입니다.", "NF"); // UserException - NF
        }
    ...
    public boolean isUserExist(String email) {
        try {
            ...
            throw new RegDBException("이메일 존재 여부 확인 중 데이터베이스 오류가 발생했습니다."); // RegDBException
        }
    }
    ...
    public List<RetUser> getAllUsers() {
        try {
            ...
            throw new RegDBException("사용자 목록 조회 중 오류가 발생했습니다."); // RegDBException
        }
    }
    ...
    public RetUser getUser(int userId) {
        try {
            ...
            throw new RegDBException("사용자 조회 중 오류가 발생했습니다."); // RegDBException
        }
    }
    ...
    public boolean modifyUser(PutUserDto putUserDto) {
        try {
            ...
            if (originalUser == null) {
                throw new UserException("존재하지 않는 사용자입니다.", "NF"); // UserException - NF
            }
            User user = new User();
            ...
            throw new RegDBException("사용자 수정 중 오류가 발생했습니다."); // RegDBException
        } catch (Exception e) {
    ...
    public boolean removeUser(int userId) {
        try {
            ...
            throw new RegDBException("사용자 삭제 중 오류가 발생했습니다."); // RegDBException
        } catch (Exception e) {
            throw new RuntimeException("예기치 않은 오류가 발생했습니다.");
        }
    }
    ...
    public boolean getEmail(String email) {
        try {
            ...
            throw new RegDBException("이메일 중복 확인 중 오류가 발생했습니다."); // RegDBException
        } catch (Exception e) {
            throw new RuntimeException("예기치 않은 오류가 발생했습니다.");
        }
    }
    ...
    public boolean getNN(String nickname) {
        try {
            ...
            throw new RegDBException("닉네임 중복 확인 중 오류가 발생했습니다."); // RegDBException
        } catch (Exception e) {
            throw new RuntimeException("예기치 않은 오류가 발생했습니다.");
        }
    }
    ...
    public boolean createProfile(int userId, Photo photo) {
        try {
            ...
            throw new RegDBException("사진 등록 중 오류가 발생했습니다."); // RegDBException
        } catch (Exception e) {
            throw new RuntimeException("예기치 않은 오류가 발생했습니다.");
        }
    }
    ...
    public boolean modifyProfile(int userId, Photo photo) {
        try {
            ...
            throw new RegDBException("사진 수정 중 오류가 발생했습니다."); // RegDBException
        } catch (Exception e) {
            throw new RuntimeException("예기치 않은 오류가 발생했습니다.");
        }
    }
    ...
    public List<RetUser> getUserByNn(String nn) {
        try {
            ...
            throw new RegDBException("닉네임으로 사용자 조회 중 오류가 발생했습니다."); // RegDBException
        } catch (Exception e) {
            throw new RuntimeException("예기치 않은 오류가 발생했습니다.");
        }
    }
    ...
    public int getUserId(String nn) {
        try {
            ...
            throw new RegDBException("닉네임으로 사용자 ID 조회 중 오류가 발생했습니다."); // RegDBException
        } catch (Exception e) {
            throw new RuntimeException("예기치 않은 오류가 발생했습니다.");
        }
    }
