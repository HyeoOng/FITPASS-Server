...
public class AdminRequestServiceImpl implements AdminRequestService {
    ...
    public boolean createRequest(PostAdminRequestDto postAdminRequestDto) {
        try {
            ...
            throw new RegDBException("관리자 요청 생성 중 데이터베이스 오류가 발생했습니다."); // DAL0001
        } catch (Exception e) {
    ...
    public List<RetAdminRequestDto> getAllRequests() {
        try {
            ...
            throw new RegDBException("관리자 요청 목록 조회 중 데이터베이스 오류가 발생했습니다."); // DAL0001
        } catch (Exception e) {
    ...
    public boolean removeRequest(int requestId) {
        try {
            ...
            throw new RegDBException("관리자 요청 삭제 중 데이터베이스 오류가 발생했습니다."); // DAL0001
        } catch (Exception e) {
